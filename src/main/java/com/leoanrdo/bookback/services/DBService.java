...
//	@Autowired
	...
	public void instaciaDB() {
		...
		Livro liv1 = new Livro(null, "O Primeiro Livro", "Joao Autor", "obs", adm1, cli1);
		Livro liv2 = new Livro(null, "O Segundo Livro", "Maria Autora", "obs", adm2, cli2);
		Livro liv3 = new Livro(null, "O Terceiro Livro", "Carlos Autor", "obs", adm2, cli3);
//		Livro liv1 = new Livro(null, "O Primeiro Livro", "obs",  "Joao Autor");
//		Livro liv2 = new Livro(null, "O Segundo Livro", "obs", "Maria Autora" );
//		Livro liv3 = new Livro(null, "O Terceiro Livro", "obs", "Carlos Autor");
